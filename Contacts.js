...
function addContact(contact){
    ...
    if(duplicateContact != null)
        console.log("Can't Add Contact. Duplicate Contact Found.")
    else
...
/* UC8: Search Particular Person by City orState
   UC9: Search All Contacts by City or State
  UC10: Get Count of Contacts by City or State
*/
...
switch (input){
    ...
    case 4:
        ...
        break
    case 5:
        let cityNum = prompt("Enter the city name:  ")
        searchedContacts = searchByCityState("","", cityNum, 5)
        console.log("Contacts Found in " + cityNum + " are:  " + searchedContacts.reduce(count,0))
        break
    case 6:
        let stateNum = prompt("Enter the state name:  ")        
...
console.log("Do You wish to Sort the Contacts:  \n1. YES \n2. NO")
